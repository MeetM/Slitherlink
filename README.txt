...
8. After each move, the program will display the current board structure and status whether or not
...
*** Note for the input file format ***
   ...
   The input board file (if you wish to try your own boards,) should be specified in the following 
   format
